        ...
        params.records = params.records.map((record) => {
            ...
            let recordFieldData = retrieveRecordFieldData(record, params.headerFields),
                ...
                processedRecordData = recordFieldData.map((fieldValue) => {
                    ...
                    let originFieldValue = trimRecordFieldValue(fieldValue); 
                    originFieldValue = recordFieldValueToString(originFieldValue);        
                    originFieldValue = wrapFieldValueIfNecessary(originFieldValue);
